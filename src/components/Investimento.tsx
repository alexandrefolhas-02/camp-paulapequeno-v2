      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 w-full relative z-10 overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-col items-center text-center relative z-10">
            ...
            <p className="mt-2 text-lg text-gold-400 font-medium">
              Apenas 30 vagas. Apenas agora.
            </p>

            {/* DESTAQUE DE PREÇO */}
            <div className="mt-10 flex flex-col items-center w-full">
              <span className="text-sm text-gray-400">investimento único de</span>
        ...
        >
          ...
          <p className="mt-6 text-sm text-gray-300 leading-relaxed min-w-0 flex-wrap">
            Após as 30 vagas de Atleta Fundador serem preenchidas, o investimento passa a ser de R$ 2.434, com todos os benefícios do Camp — exceto os exclusivos da 1ª edição (numeração serial, foto autografada, pin colecionável, grupo de fundadores).
          </p>
        ...
        <div className="mt-12 max-w-3xl mx-auto w-full text-center">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-6 md:gap-10 min-w-0">
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-xs text-gray-400 font-semibold">CARTÃO</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-xs text-gray-400 font-semibold">PIX</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-xs text-gray-400 font-semibold">BOLETO</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-xs text-gray-400 font-semibold">PAGBANK</span>
            </div>
          </div>

          <div className="mt-6 flex items-center justify-center gap-2 text-xs text-gray-400 min-w-0 flex-wrap">
